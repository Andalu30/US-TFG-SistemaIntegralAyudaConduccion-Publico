...
writer = cv2.VideoWriter(f"recordOutput.avi", cv2.VideoWriter_fourcc(*"MJPG"), 30,(1280,720))
...
# Inicialización
visionData = inputDatosVision('../videos/carretera3')
...
semafModel = tf.keras.models.load_model('../usoDeDatos/nuevoModeloBinario10epochs.h5')
